            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-primary">{{ __('Update Role') }}<i class="bi bi-check"></i>
                        </button>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="show_weekly_sales_purchases">{{ __('Weekly Sales & Purchases') }}</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="access_products">{{ __('Access') }}</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-switch">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label" for="create_quotation_sales">{{ __('Sale From Quotation') }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
