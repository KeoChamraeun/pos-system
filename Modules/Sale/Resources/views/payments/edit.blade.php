                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $salePayment->payment_method == 'Cash' ? 'selected' : '' }} value="Cash">{{ __('Cash') }}</option>
                                                <option {{ $salePayment->payment_method == 'Credit Card' ? 'selected' : '' }} value="Credit Card">{{ __('Credit Card') }}</option>
                                                <option {{ $salePayment->payment_method == 'Bank Transfer' ? 'selected' : '' }} value="Bank Transfer">{{ __('Bank Transfer') }}</option>
                                                <option {{ $salePayment->payment_method == 'Cheque' ? 'selected' : '' }} value="Cheque">{{ __('Cheque') }}</option>
                                                <option {{ $salePayment->payment_method == 'Other' ? 'selected' : '' }} value="Other">{{ __('Other') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
