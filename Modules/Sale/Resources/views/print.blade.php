...
<head>
    ...
    <style>
        /* Use absolute path with file:/// */
        @font-face {
            font-family: 'KhmerOS';
            src: url('file:///var/www/pos-system/public/fonts/KhmerOS_battambang.ttf') format('truetype');
            font-weight: normal;
            font-style: normal;
        }
            ...
            <table class="table-data">
                <tbody>
                    ...
                    @if($sale->discount_percentage)
                        <tr>
                            <th colspan="2" style="text-align:left">
                                {{ __('Discount') }} ({{ $sale->discount_percentage }}%)
                            </th>
