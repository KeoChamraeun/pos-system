            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small ">{{ $total_sales }} {{ __('Sales') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_sale_returns }} {{ __('Sale Returns') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_purchases }} {{ __('Purchases') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_purchase_returns }} {{ __('Purchase Returns') }}</div>
                    </div>
                </div>
            </div>
        </div>
